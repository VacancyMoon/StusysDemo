...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<?php echo U('Student/info');?>" target="right"><span class="icon-caret-right"></span>学生信息列表</a></li> 
     <li><a href="<?php echo U('Student/stu_add');?>" target="right"><span class="icon-caret-right"></span>添加学生信息</a></li>
     <li><a href="<?php echo U('Student/score');?>" target="right"><span class="icon-caret-right"></span>公共选课系统</a></li>  
   <!--  
    <li><a href="<?php echo U('Student/stu_add');?>" target="right"><span class="icon-caret-right"></span>修改密码</a> </li>-->
    <li><a href="<?php echo U('Student/score');?>" target="right"><span class="icon-caret-right"></span>考试成绩查询</a></li>  
