...
<td align="center"><?php echo ($rs['stu_study']); ?></td>
<td>
<a class="button button-little bg-green" href="<?php echo U('admin_info_modify?stu_num='.$rs['stu_num']);?>" target="_blank"> 修改</a>
<a href="<?php echo U('admin_info_delete?stu_num='.$rs['stu_num']);?>" class="button button-little bg-blue"> 删除</a> 
</td>
