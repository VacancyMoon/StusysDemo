...
<title></title>
<link rel="stylesheet" href="/web/Public/css/pintuer.css">
<link rel="stylesheet" href="/web/Public/css/admin.css">
<script src="/web/Public/js/jquery.js"></script>
<script src="/web/Public/js/pintuer.js"></script>
</head>
<body>
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span> 修改登录密码</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/web/index.php/Home/Student/password_pass">
