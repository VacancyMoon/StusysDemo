...
<td align="center"><?php echo ($rs['stu_course']); ?></td>
<td align="center"><?php echo ($rs['stu_type']); ?></td>
<td align="center"><?php echo ($rs['stu_score']); ?></td>
<td>
<a class="button button-little bg-green" href="<?php echo U('admin_score_modify?id='.$rs['id']);?>" target="_blank"> 修改</a>
<a href="<?php echo U('admin_score_delete?id='.$rs['id']);?>" class="button button-little bg-blue"> 删除</a> 
</td>
